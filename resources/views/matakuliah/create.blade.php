            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('matakuliah.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="kode_mk" value="{{ old('kode_mk') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div class="mb-4">
                        <label class="block font-medium text-sm text-gray-700">Nama Mata Kuliah</label>
                        <input type="text" name="nama_mk" value="{{ old('nama_mk') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>

                    <div class="mb-4">
                        <label class="block font-medium text-sm text-gray-700">SKS</label>
                        <input type="number" name="sks" value="{{ old('sks') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
