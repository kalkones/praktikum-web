            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('nilai.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" name="nilai_angka" value="{{ old('nilai_angka') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="nilai_huruf" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            ...
                            <option value="A" {{ old('nilai_huruf') == 'A' ? 'selected' : '' }}>A</option>
                            <option value="B" {{ old('nilai_huruf') == 'B' ? 'selected' : '' }}>B</option>
                            <option value="C" {{ old('nilai_huruf') == 'C' ? 'selected' : '' }}>C</option>
                            <option value="D" {{ old('nilai_huruf') == 'D' ? 'selected' : '' }}>D</option>
                            <option value="E" {{ old('nilai_huruf') == 'E' ? 'selected' : '' }}>E</option>
                        </select>
                    </div>
